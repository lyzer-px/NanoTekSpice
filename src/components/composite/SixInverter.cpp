...
void SixInverter::registerInternComponentsPins()
{
   ...
   _inputPins[3] = std::pair{_components[1].get(), 1}; 
   _inputPins[4] = std::pair{_components[1].get(), 2}; 
   _inputPins[5] = std::pair{_components[2].get(), 1}; 
   _inputPins[6] = std::pair{_components[2].get(), 2}; 
   _inputPins[7] = std::pair{nullptr, 0}; 
   _inputPins[8] = std::pair{_components[3].get(), 2}; 
   _inputPins[9] = std::pair{_components[3].get(), 1}; 
   _inputPins[10] = std::pair{_components[4].get(), 2}; 
   _inputPins[11] = std::pair{_components[4].get(), 1}; 
   _inputPins[12] = std::pair{_components[5].get(), 2}; 
   _inputPins[13] = std::pair{_components[5].get(), 1}; 
...
SixInverter::SixInverter(std::string name): ACompositeComponent{std::move(name)}
{
    ...
    this->registerInternComponentsPins();
    this->setPinsType();
}
